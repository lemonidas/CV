...
\begin{rSection}{Books}
  ...
  {\bf Foundations of Probabilistic Programming} \hfill {\em to appear}\\
  {\em Editors:} {Gilles Barthe, Joost-Pieter Katoen, and Alexandra Silva}\\
  {\em Chapter:} Luck: A Probabilistic Language for Testing\\
  {Leonidas Lampropoulos, Diane Gallois-Wong, C\u{a}t\u{a}lin Hri\c{t}cu, John Hughes, Benjamin C. Pierce and Li-yao Xia}\\
